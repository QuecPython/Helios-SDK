...
#define MICROPY_QPY_MODULE_USSD             (1)
...
#define MICROPY_QPY_MODULE_ETHERNET         (0)
...
#define MICROPY_QPY_MODULE_URSA             (1)
    ...
    #define MICROPY_QPY_ETHERNET_W5500          (0)
#endif

#if MICROPY_QPY_MODULE_TP
    #define MICROPY_QPY_TP_XPT2046              (0)
    #define MICROPY_QPY_TP_GT9XX                (0)
    #define MICROPY_QPY_TP_CST816               (0)
    #define MICROPY_QPY_TP_FT6X36               (0)
#endif
...
#define MICROPY_QPY_GC_HEAP_SIZE            (624 * 1024)
...
#define MICROPY_QPY_EMIT_XTENSAWIN              (1)  //flash 19776 Byte
