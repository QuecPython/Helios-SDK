...
#define QUEC_AUTHCODE_FILE FACTORYNV_DIR_ROOT"/qauthcode.bin"
#define QUEC_MAX_AUTHCODE_LEN (108)
#define QUEC_MAX_AUTHCODE_TOTAL_LEN (QUEC_MAX_AUTHCODE_LEN+1)
...
#define QUEC_SDDET_CONFIG  QUEC_CONFIG_DIR_ROOT"/sddet_cfg.nv"
#endif
...
#define QUEC_CREG_EMERGENCY_CONFIG QUEC_CONFIG_DIR_ROOT"/creg_report_emergency.nv"
...
#define QUEC_JAMDET_CONFIG  QUEC_CONFIG_DIR_ROOT"/jamdet_cfg.nv"
#endif
