 ...
 * SOC name
 */
#define CONFIG_SOC "8910"

/**
 * build target
 */
#define CONFIG_BUILD_TARGET "8915DM_cat1_open"

/**
 * Build identify string
 */
#define CONFIG_BUILD_IDENTIFY "1.5 RLS W23.31.1"
 ...
 */
#define CONFIG_FS_SYS_FLASH_SIZE 0x100000

/**
 * NOR flash address of system secure data 
 */
#define CONFIG_SECDAT_FLASH_ADDRESS 0x60400000

/**
 * reserved NOR flash size for system secure data
 */
#define CONFIG_SECDAT_FLASH_SIZE 0x10000

/**
 * NOR flash address of system python U/B file system config
 */
#define CONFIG_FS_PY_C_FLASH_ADDRESS 0x60410000

/**
 * reserved NOR flash size for system python U/B file system config
 */
#define CONFIG_FS_PY_C_FLASH_SIZE 0x10000

/**
 * NOR flash address of system python U lfs file system
 *
 * The mount point of system file system is \p CONFIG_FS_SYS_MOUNT_POINT.
 */
#define CONFIG_FS_PY_U_FLASH_ADDRESS 0x60420000

/**
 * reserved NOR flash size for system file system
 */
#define CONFIG_FS_PY_U_FLASH_SIZE 0x60000
 ...
 * The mount point of system file system is \p CONFIG_FS_SYS_MOUNT_POINT.
 */
#define CONFIG_FS_PY_B_FLASH_ADDRESS 0x60480000

/**
 * reserved NOR flash size for system file system
 */
#define CONFIG_FS_PY_B_FLASH_SIZE 0x20000

/**
 * NOR flash address of system python L lfs file system
 *
 * The mount point of system file system is \p CONFIG_FS_SYS_MOUNT_POINT.
 */
/* #undef CONFIG_FS_PY_L_FLASH_ADDRESS */

/**
 * reserved NOR flash size for system file system
 */
/* #undef CONFIG_FS_PY_L_FLASH_SIZE */
 ...
 */
#define CONFIG_APP_RAM_SIZE 0x330000
 ...
 */
#define CONFIG_APP_FLASHIMG_RAM_OFFSET 0xf30000

/**
 * PSRAM or DDR size for app image from NOR flash
 */
#define CONFIG_APP_FLASHIMG_RAM_SIZE 0xD0000
 ...
 */
#define CONFIG_BOARD_SIM1_DETECT_GPIO 22
 ...
 * sys_wdt timeout
 */
#define CONFIG_SYS_WDT_TIMEOUT 30000
