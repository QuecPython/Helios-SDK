...
#include <time.h>
#include <stdint.h>
#if defined (PLAT_Qualcomm) ||  defined (PLAT_RDA) || defined(PLAT_ECR6600) || defined(PLAT_aic8800m40)
#include "helios_rtc.h"
#endif

#if defined (PLAT_Unisoc_8850) || defined(PLAT_Unisoc_8850_R02) || defined(PLAT_Unisoc_8910_R06)
#include "sockets.h"
#endif

#if defined (PLAT_ASR) || defined (PLAT_Qualcomm) || defined (PLAT_ASR_1803s) || defined (PLAT_ASR_1803sc)  || defined(PLAT_ASR_1606) || defined(PLAT_ASR_1609) \
    || defined(PLAT_RDA) || defined(PLAT_ASR_1602) || defined(PLAT_ECR6600) || defined(PLAT_aic8800m40)
struct timeval { 
	int tv_sec; 
	int tv_usec;
};
...
{
	(void)tz;
	tv->tv_sec = Helios_Get_CurrentDateTime_Second();
    // usec is not right because this platform can't right get us time 
	tv->tv_usec = (Helios_RTC_TicksToUs()%1000)*1000;
}
time_t time(time_t *t)
{
	(void)t;
    return (time_t)Helios_Get_CurrentDateTime_Second();
}
