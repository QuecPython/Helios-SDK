 ...
 */
#define CONFIG_ATR_CMD_PARAM_MAX 30
 ...
 */
/* #undef CONFIG_ATR_CMUX_IN_BUFF_SIZE */
 ...
 * content of the buffer will be dropped silently.
 */
/* #undef CONFIG_ATR_CMUX_OUT_BUFF_SIZE */

/**
 * CMUX sub-channel minimum input buffer size
 */
/* #undef CONFIG_ATR_CMUX_SUBCHANNEL_MIN_IN_BUFF_SIZE */

/**
 * CMUX maximum DLC number
 */
/* #undef CONFIG_ATR_CMUX_DLC_NUM */
 ...
 */
/* #undef CONFIG_ATS_UPDATE_SUPPORT */
 ...
 * Size for each read
 */
#define CONFIG_AT_DISPATCH_FETCH_BUF_SIZE 512
...
#define CONFIG_AT_ENGINE_SUPPORT_RUN_PREVIOUS_COMMAND

/* #undef CONFIG_AT_CMUX_SUPPORT_UBLOX_CASE */
